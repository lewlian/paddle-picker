    ...
    <div>
      ...
      {selected && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm p-4" onClick={() => setSelected(null)}>
          <div
            className="bg-[#FFFDF9] rounded-3xl shadow-2xl max-w-lg w-full max-h-[80vh] overflow-y-auto overflow-x-hidden p-6 animate-slide-up scrollbar-thin"
          ...
          >
            <div className="mb-4">
              ...
              <button
                ...
                className="mt-3 w-full inline-flex items-center justify-center gap-2 bg-[#1A4D2E] text-white font-semibold px-4 py-2.5 rounded-xl hover:bg-[#153D24] transition-colors text-sm"
              >
                ⚖️ Add to Compare
              </button>
            </div>
